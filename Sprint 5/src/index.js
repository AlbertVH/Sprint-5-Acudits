...
var reportJokes = []; //Definicion array para almacenar objetos JOKES
var joke = {
    text: "",
    score: 1,
...
function getJoke() {
    return __awaiter(this, void 0, void 0, function () {
        var response, result, jokeDom;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (joke.text !== "") { //Si hay chiste, lo añadimos como objeto joke en array reportJokes
                        reportJokes.push(__assign({}, joke));
                        console.log(reportJokes);
                    }
                    return [4 /*yield*/, fetch("https://icanhazdadjoke.com/", { headers: {
                ...
                case 2:
                    ...
                    jokeDom = document.getElementById("joke");
